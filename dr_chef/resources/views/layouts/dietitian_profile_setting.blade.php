        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <div id="profile-section" style="padding-left: 20px ">
                    <h3>Profile</h3><br>
                    <form method="POST" action="update_dietitian_profile" enctype="multipart/form-data">
                        @csrf
                        ...
                        <img id="preview" class="user-profile-img"
                            src="{{ asset('/images/dietitian_profile_images/' . $dietitian->dietitian_profile_pic) }}"
                            name="dietitian_profile_pic">
                        <br>
                        ...
                        <label for="name" class="label">Full Name </label><input type="text"
                            value="{{ $dietitian->dietitian_full_name }}" name="dietitian_full_name"><br>
                        ...
                        <label for="username" class="label">Username </label><input type="text"
                            value="{{ $dietitian->dietitian_username }}" name="dietitian_username"><br>
                        ...
                        <label for="email" class="label-email">Email</label><input type="text"
                            value="{{ $dietitian->dietitian_email }}" name="dietitian_email"><br>
                ...
                <div id="password-section" style="display:none; padding-left: 20px">
                    ...
                    <form method="POST" action="update_dietitian_password" enctype="multipart/form-data">
                        @csrf
                ...
                <div id="delete-section" style="display:none; padding-left: 20px">
                    ...
                    <form method="POST" action="delete_dietitian_account" enctype="multipart/form-data">
                        @csrf
