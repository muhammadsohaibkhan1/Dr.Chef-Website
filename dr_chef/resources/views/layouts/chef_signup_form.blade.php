    ...
    <div class="page-wrapper p-b-100" style="padding-top: 50px">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                <div class="card-heading chef-form">
                    <div class="card-box paragraph-style">
                        <p class="text-center" style="width: 300px"><span class="chef-signup-title-text">Share
                                Flavors, Create Joy!</span> <br><br>
                            <span class="chef-signup-paragraph-text">Join our community of passionate chefs and share
                                your delicious recipes with food enthusiasts. Register now and let's bring your culinary
                                expertise to the world!</span>
                        </p>
                    </div>
                </div>
                <div class="card-body">
