...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/update_diet_plan.css') }}">
...
<body>
    ...
    @foreach ($data as $d)
        <form method="post" action="{{ route('update/dietPlan', $d->diet_plan_id) }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-lg-6" style="background-color: #EBD7CC; border-radius: 15px;">
                                <div class="p-3">
                                    <h2 style="padding-top: 8px" class="mb-5 text-center text-dark">Update Diet Plan
                                    </h2>
                                    <div class="mb-4 pb-2">
                                        <div class="form-outline">
                                            <p><label style="font-weight:bold; font-size:14px" for="">Diet Plan
                                                    Duration (Days)</label>
                                                <input type="number" placeholder="Plan Duration"
                                                    class="input--style-4 placeholder-text placeholder-text-pt-pb"
                                                    name="diet_plan_duration" value="{{ $d->diet_plan_duration }}">
                                            </p>
                                    ...
                                    <div class="mb-4 pb-2">
                                        <p><label style="font-weight:bold; font-size:14px" for="">Compatible For
                                            </label>
                                            <select
                                                class="input--style-4 placeholder-text placeholder-text-pt-pb w-100 border-0"
                                                name="diet_plan_user_type">
                                                <option value="" selected disabled
                                                    @if ($d->diet_plan_user_type == '') @selected(true) @endif>Compatible
                                                    For</option>
                                                <option value="healthy person"
                                                    @if ($d->diet_plan_user_type == 'healthy person') @selected(true) @endif>Healthy
                                                    Person</option>
                                                <option value="diabetic patient"
                                                    @if ($d->diet_plan_user_type == 'diabetic patient') @selected(true) @endif>Diabatec
                                                    Patient</option>
                                                <option value="cardiac patient"
                                                    @if ($d->diet_plan_user_type == 'cardiac patient') @selected(true) @endif>Cardiac
                                                    Patient</option>
                                                <option value="blood pressure patient"
                                                    @if ($d->diet_plan_user_type == 'blood pressure patient') @selected(true) @endif>Blood
                                    ...
                                    <div class="mb-4 pb-2">
                                        <div class="form-outline">
                                            <p><label style="font-weight:bold; font-size:14px" for="">Diet
                                                    Plan Type</label>
                                                <select required name="diet_plan_type"
                                                    class="input--style-4 placeholder-text placeholder-text-pt-pb w-100 border-0">
                                                    <option value=""
                                                        @if ($d->diet_plan_type == '') @selected(true) @endif
                                                        selected disabled hidden>Select Diet Plan Type</option>
                                                    <option
                                                        value="gain weight"@if ($d->diet_plan_type == 'gain weight') @selected(true) @endif>
                                                        Gain Weight</option>
                                                    <option
                                                        value="lose weight"@if ($d->diet_plan_type == 'lose weight') @selected(true) @endif>
                                                        Lose Weight</option>
                                                </select>
                                            </p>
                                    ...
                                    <div class="mb-4 pb-2">
                                        <div class="form-outline">
                                            <p>
                                                <label style="font-weight:bold; font-size:14px" for="">Weight
                                                    Goal (Kg)</label>
                                                <input type="text"
                                                    class="input--style-4 placeholder-text placeholder-text-pt-pb"
                                                    placeholder="Enter Weight Goal (Kg)" name="diet_plan_weight_goal"
                                                    value="{{ $d->diet_plan_weight_goal }}">
                                            </p>
                                        ...
                                        <div class="form-outline">
                                            <p>
                                                <label style="font-weight:bold; font-size:14px" for="">
                                                    Upload Diet Plan (PDF)</label>

                                                <input type="file"
                                                    class="input--style-4 placeholder-text placeholder-text-pt-pb"
                                                    name="diet_plan_meals" id="pdfInput" accept="application/pdf">
                                            </p>
