...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav d-flex align-items-center">
                    ...
                    @if (session()->has('user_login_data'))
                        <li class="nav-item">
                            <a class="nav-link px-3 active" href="{{ route('display/save/recipe') }}"><span
    ...
    <br><br>
    <h4 class="saved-recipes-title text-center">Saved Recipes</h4><br>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card" style="height: 420px">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text card-text-color"> {{ $d->recipe_calories }} Calories<br>
                                            <span style="font-weight: bold"><br>
                                                By Chef </span><a href="{{ route('view/chef/profile', $d->chef_id) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div style="float: left;">
                                                    @if (!$d->recipe_like_id == null && $d->user_id == session()->get('user_login_data.user_id'))
