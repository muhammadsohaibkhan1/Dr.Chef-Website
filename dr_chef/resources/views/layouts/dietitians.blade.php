...
<head>
    ...
    <!-- display_recipes CSS-->
    <link href="{{ asset('css/dietitians.css') }}" rel="stylesheet" media="all">
...
<body>
    ...
    <div class="text-center">
        <h3>Get Personlized Diet Plans <br>From Certified Dietitians</h3>
    </div>
    <br>
                ...
                @foreach ($data as $d)
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card mb-3">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('images/dietitian_profile_images/' . $d->dietitian_profile_pic) }}"
                                        alt="Profile Image" class="img-fluid">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $d->dietitian_full_name }}</h5>
                                        <p class="card-text">@ {{ $d->dietitian_username }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between">
                                <div>
                                    ...
                                    <span class="ms-1">{{ $d->dietitian_likes }}</span>
                                </div>
                                <div>
                                    <a class="bi bi-whatsapp"
                                        href="https://api.whatsapp.com/send?phone={{ $d->dietitian_phone_number }}&text=Can I get personalized diet plan"
                                        class="add-diet-plan-btn" target="_blank"></a>
                                </div>
                            </div>
                        </div>
                    </div>
