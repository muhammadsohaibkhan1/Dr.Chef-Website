        ...
        <div class="col-12 col-md-9 p-2">
            <div class="profile-info">
                @foreach ($profile as $d)
                    ...
                    @if($accessedBy=='admin'|| $accessedBy == 'dietitian')
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    @elseif ($d->is_liked_chef == 1)
                        <form action="{{ route('like/chef', $d->chef_id) }}">
                            <button type="submit" class="like-recipe-btn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                        ...
                        @foreach ($data as $d)
                            <div class="col-md-4">
                                ...
                                <div class="card" style="height: 380px">
                                    ...
                                    <div class="card-body">
                                        @if ($accessedBy=='admin')
                                        <a href="{{ route('recipe/display/detail', ['id' => $d->recipe_id, 'accessedBy'=>"admin"]) }}">
                                            <h6 style="font-weight: bold" class="card-title card-text-color">
                                                {{ $d->recipe_name }} </h6>
                                        </a>
                                        @elseif ($accessedBy == 'dietitian')
                                        <a href="{{ route('recipe/display/detail', ['id' => $d->recipe_id, 'accessedBy'=>"dietitian"]) }}">
                                            <h6 style="font-weight: bold" class="card-title card-text-color">
                                                {{ $d->recipe_name }} </h6>
                                        </a>
                                        @else
