...
<body onload="ShowChart()">
        ...
        <div class="d-flex flex-column mb-3">
            <div class="p-2">
                <div class="d-flex flex-row mb-3 justify-content-around days-bar">
                    ...
                    <div class="p-2"><a class="active" href="{{ route('calorietracker/weekly') }}">Weekly</a>
                    </div>
            ...
            <div class="p-2">
                <canvas id="calorieBarChartWeekly" height="360"></canvas>
            </div>
            <br>
            <hr><br>
        </div>
                    ...
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Carbohydrates</span><span
                                class="align-right">{{ $nutrients->weekly_carbs }} g</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Protein</span><span
                                class="align-right">{{ $nutrients->weekly_protein }}
                                g</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Iron</span><span
                                class="align-right">{{ $nutrients->weekly_iron }}
                                mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Dietary Fiber</span><span
                                class="align-right">{{ $nutrients->weekly_fiber }} g</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Sugar</span><span
                                class="align-right">{{ $nutrients->weekly_sugar }}
                                g</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Calcium</span><span
                                class="align-right">{{ $nutrients->weekly_calcium }}
                                mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Magnesium</span><span
                                class="align-right">{{ $nutrients->weekly_magnesium }} mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Potassium</span><span
                                class="align-right">{{ $nutrients->weekly_potassium }} mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Sodium</span><span
                                class="align-right">{{ $nutrients->weekly_sodium }}
                                mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Vitamin C</span><span
                                class="align-right">{{ $nutrients->weekly_vitamin_c }} mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Vitamin D</span><span
                                class="align-right">{{ $nutrients->weekly_vitamin_d }} µg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Vitamin B-6</span><span
                                class="align-right">{{ $nutrients->weekly_vitamin_b6 }} mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Vitamin B-12</span><span
                                class="align-right">{{ $nutrients->weekly_vitamin_b12 }} µg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Cholesterol</span><span
                                class="align-right">{{ $nutrients->weekly_cholesterol }} mg</span>
                        </div>
                    </div>
                    <div class="p-2">
                        <div class="nutrient">
                            <span class="align-left">Fats</span><span
                                class="align-right">{{ $nutrients->weekly_fats }}
                                g</span>
                        </div>
                    </div>
                </div>
    ...
    {{-- Javascript for weekly bar chart --}}
