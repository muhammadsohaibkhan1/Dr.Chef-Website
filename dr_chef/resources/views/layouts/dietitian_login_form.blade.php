    ...
    <div class="page-wrapper p-b-100" style="padding-top: 50px">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body ">
                    <h2 class="title p-t-30 ">Login</h2>
                    <form method="POST" action="dlogin" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group">
                            <input class="input--style-3 placeholder-text" type="email" placeholder="Email"
                        ...
                        <div class="input-group">
                            <input class="input--style-3 placeholder-text" type="password" placeholder="Password"
                        ...
                        <div class="p-t-10 text-center">
                            <small>Doesn't have an account? <a href="{{ route('dietitians/signupform') }}"
                                    class="login-reg-link">Register</a></small>
                            <br><br>
                            <button class="btn btn--pill btn--brown" type="submit">Login</button>
                        </div>
                    </form>
                </div>
            </div>
