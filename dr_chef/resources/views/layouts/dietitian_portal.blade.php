    ...
    <div class="d-flex flex-wrap main-div">
        ...
        <div class="col-12 col-md-9 p-2">
            <div class="profile-info">
                ...
                @endforeach
                <br><br>
                <a href="{{ route('add_diet_plan_form') }}" class="add-diet-plan-btn"
                    title="Add Diet Plan Meals Only From Dr. Chef Recipes">Add Diet Plan</a>
            </div>
        </div>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="widget-49">
                                            ...
                                            <div style="display: inline-block; float: right;">
                                                <a href="{{ url('edit/dietPlan', $d->diet_plan_id) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor"
                                                ...
                                                &nbsp;
                                                <a href="{{ url('delete/dietPlan', $d->diet_plan_id) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" fill="currentColor" class="bi bi-trash"
                                                        style="color: #ba0e02" viewBox="0 0 16 16">
                                                        <path
