    ...
    <div class="page-wrapper p-b-100" style="padding-top: 50px">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                <div class="card-heading user-form">
                    <div class="card-box paragraph-style">
                        <p class="text-center" style="width: 300px"><span class="chef-signup-title-text">Revitalize
                                Your
                                Diet Journey!</span> <br><br>
                            <span class="chef-signup-paragraph-text">Discover a healthier you with Dr. Chef! Get free
                                and personalized diet plans. Effortlessly monitor your daily calorie intake and start
                                your journey towards a balanced lifestyle.</span>
                        </p>
                    </div>
                </div>
                <div class="card-body ">
                    <h2 class="title p-t-30 ">Login</h2>
                    <form method="POST" action="ulogin" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="p-t-10 text-center">
                            <small>Doesn't have an account? <a href="{{ route('user/signupform') }}"
