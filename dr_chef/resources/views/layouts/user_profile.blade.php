        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <div id="profile-section" style="padding-left: 20px ">
                    <h3>Profile</h3><br>
                    <form method="POST" action="update_user_profile" enctype="multipart/form-data">
                        @csrf
                        <input class="input--style-3" type="file" name="user_profile_pic"
                            onchange="loadImage(event)" style="display:none" id="profile_pic">
                        <img id="preview" class="user-profile-img"
                            src="{{ asset('/images/user_profile_images/' . $user->user_profile_pic) }}"
                        ...
                        <label for="name" class="label">Full Name </label><input type="text"
                            value="{{ $user->user_full_name }}" name="user_full_name"><br>
                        ...
                        <label for="username" class="label">Username </label><input type="text"
                            value="{{ $user->user_username }}" name="user_username"><br>
                        @error('user_username')
                            <label style="color: red; padding-left: 100px">{{ $message }}</label>
                        @enderror
                        <br>
                        ...
                        <label for="email" class="label-email">Email</label><input type="text"
                            value="{{ $user->user_email }}" name="user_email"><br>
                        @error('user_email')
                            <label style="color: red; padding-left: 100px">{{ $message }}</label>
                        @enderror
                        <br>
                        ...
                        @endif
                        <label for="age" class="label-age">Age </label><input type="number"
                            value="{{ $user->user_age }}" name="user_age"><br>
                        @error('user_age')
                            <label style="color: red; padding-left: 100px">{{ $message }}</label>
                        @enderror
                        <br>
                        <label for="gender" class="label-gender">Gender </label><input type="text"
                            value="{{ $user->user_gender }}" readonly name="user_gender"><br><br>
                        <label for="height" class="label-height">Height (Ft) </label><input type="number"
                            step="0.01" value="{{ $user->user_height }}" name="user_height"><br>
                        @error('user_height')
                            <label style="color: red; padding-left: 100px">{{ $message }}</label>
                        @enderror
                        <br>
                        <label for="weight" class="label-weight">Weight (Kg) </label><input type="number"
                            step="0.01" value="{{ $user->user_weight }}" name="user_weight"><br>
                        @error('user_weight')
                            <label style="color: red; padding-left: 100px">{{ $message }}</label>
                        @enderror
                        <br>
                        <label for="activity" class="label-activity">Activity Level </label><select
                            name="user_activity" required>
                            <option value="{{ $user->user_activity }}" selected hidden>{{ $user->user_activity }}
                            </option>
                        ...
                        <br><br>
                        <label for="disease" class="label-disease">Disease </label><select name="user_disease"
                            required>
                            <option value="{{ $user->user_disease }}" selected hidden>{{ $user->user_disease }}
                            </option>
                            <option value="none">None</option>
                            <option value="diabetic">Diabatec Patient</option>
                            <option value="cardiac">Cardiac Patient</option>
                            <option value="blood pressure">Blood Pressure Patient</option>
                        </select>
                        <br><br>
                        <label for="weight_goal" class="label-goal">Weight Goal</label>
                        <select name="user_weight_goal" required>
                            <option value="{{ $user->user_weight_goal }}" selected hidden>
                                {{ $user->user_weight_goal }}
                            </option>
                ...
                <div id="password-section" style="display:none; padding-left: 20px">
                    ...
                    <form method="POST" action="update_user_password" enctype="multipart/form-data">
                        @csrf
                ...
                <div id="delete-section" style="display:none; padding-left: 20px">
                    ...
                    <form method="POST" action="delete_user_account" enctype="multipart/form-data">
                        @csrf
