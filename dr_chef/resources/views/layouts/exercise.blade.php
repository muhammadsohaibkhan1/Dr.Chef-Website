...
<head>
    ...
    <script src="{{ asset('js/burned_calories.js') }}"></script>
    <!-- Title Page-->
    ...
    <link rel="stylesheet" href="{{ asset('css/exercise.css') }}" media="all">
...
<body>
    ...
    <div class="exercises-bg-1">
        ...
        @endif
        <div class="exercises-bg-2">
            <!-- Grid of Exercise Code Start -->
            <div class="container">
                <div class="row row-cols-auto" style="row-gap: 25px;">
                    @foreach ($exercises as $exercise)
                        <div class="col-md-4">
                            <!-- Exercise Card Code Start -->
                            <div class="card" style="width: 250px;">
                                <img src="{{ asset('images/exercise_images/' . $exercise->exercise_image) }}"
                                    alt="{{ $exercise->exercise_image }}" class="card-img-top" height="210px"
                                    style="object-fit: cover;">
                                <div class="card-body">
                                    <h5 class="card-title card-text-color text-center">{{ $exercise->exercise_name }}
                                    </h5>
                                    <br>
                                    <div style="text-align:center;">
                                        <input type="hidden" id="met_{{ $exercise->exercise_id }}"
                                            value="{{ $exercise->met_value }}">
                                        <button class="card-btn" data-bs-toggle="modal" data-bs-target="#myModal"
                                            data-exercise-id="{{ $exercise->exercise_id }}"
                                            data-exercise-name="{{ $exercise->exercise_name }}"
                                            onclick="setExerciseId(this.getAttribute('data-exercise-id')); setExerciseName(this.getAttribute('data-exercise-name'));">
                                            Exercise Calories
                                        </button>
                                        <!-- The Modal -->
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header" style="align-self:center">
                                                        <h4 id="exerciseName" class="modal-title placeholder-text"
                                                            style="font-weight:bold">
                                                        </h4>
                                                    </div>

                                                    <!-- Modal body -->
                                                    <div class="modal-body bg-lt-brown">
                                                        <div class=" container w-50"><br>
                                                            <center>
                                                                <h4 style="color:#000;">Calculate Exercise Calories
                                                                </h4>
                                                            </center>
                                                            <input type="hidden" id="user_weight"
                                                                value="{{ $user->user_weight }}">
                                                            <div class="row justify-content-center">
                                                                <div class="col-12 col-md-12">
                                                                    <br><br>
                                                                    <input id="exercise_time"
                                                                        class="input--style-3 placeholder-text"
                                                                        type="number" min="0"
                                                                        placeholder="Exercise Duration (minutes)"><br>
                                                                    <button id="calculate" class="btn2"
                                                                        onclick="burnedCalories()">Calculate</button>
                                                                    <br><br>
                                                                    <label class="text"
                                                                        id="result"></label><br><br>
                                                                    <form method="GET"
                                                                        action="{{ route('burned_calories') }}">
                                                                        @csrf
                                                                        <input type="hidden" id="burned_calories"
                                                                            name="burned_calories">
                                                                        <button id="add" class="card-btn"
                                                                            type="submit"
                    ...
                    @endforeach
                    <!-- Exercise Card Code End -->
                </div>
            </div>
            <!-- Grid of Exercise Code End -->
        </div>
    </div>
